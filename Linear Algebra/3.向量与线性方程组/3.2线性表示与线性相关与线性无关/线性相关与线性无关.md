...
3. 设向量组$A$线性无关, 而向量组$B:a_1,\cdots,a_m,b$线性相关,
   则向量$b$必能由向量组$A$线性表示, 且表示式是惟一的.
...
向量组$\pmb{\alpha_1}, \pmb{\alpha_2}, \dots, \pmb{\alpha_m}$线性无关$\iff k_i\equiv0, \sum\limits_{i=1}^n k_i\pmb{\alpha_i}=0$
